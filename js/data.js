var places = [
    ...
    [
        ...
        new _localization("A hill", "13.gif", "rgb(117,237,243)", 7, [22, 0, 0]),
        new _localization("Some bushes", "14.gif", "rgb(202,230,51)", 5, [0, 0, 0]),
        new _localization("An old deserted hut", "15.gif", "rgb(220,204,61)", 5, [18, 0, 0]),
        new _localization("The edge of a forest", "16.gif", "rgb(167,245,63)", 5, [0, 0, 0]),
        new _localization("A dark forest", "17.gif", "rgb(140,253,99)", 3, [5, 0, 0])
    ],
    ...
    [
        ...
        new _localization("You are by a roadside shrine", "23.gif", "rgb(167,245,63)", 15, [1, 0, 0]),
        ...
        new _localization("You are in a deep forest", "27 i 67.gif", "rgb(140,253,99)", 9, [9, 0, 0])
    ],

    //------------------------3
    [
        new _localization("You are by the Vistula River", "31.gif", "rgb(122,232,252)", 12, [0, 0, 0]),
        new _localization("You are by the Vistula River", "32.gif", "rgb(140,214,255)", 9, [23, 0, 0]),
    ...
    [
        ...
        new _localization("You are by the water mill", "44.gif", "rgb(255,190,99)", 4, [12, 0, 0]),
    ...
    [
        ...
        new _localization("You are on a street leading forest", "55.gif", "rgb(255,190,99)", 11, [24, 0, 0]),
    ...
    [
         , , ,
        new _localization("You are in a bleak funeral house", "64.gif", "rgb(254,194,97)", 4, [15, 0, 0]),
